                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">Java For Begineer</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/OIP.jpeg" alt="Image">
                        <h4>What you'll learn :</h4>
                        
                        <p> --> Create their own java Programs.</p>
                          <p>--> Become an experienced java Programmer.</p>
                        ...
                        <div class="py-3 px-4">
                           ...
                           <?php
                            ...
                            {  
                                 ...
                                 $query2="select * from sid_cid  where cid=102 and username = '$data2' ";
                                    ...
                                    if(isset($_POST['submit']))
                                      {
                                        ...
                                        $query3="insert into sid_cid() values('$data2',102)";
