                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">C++ Programming</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/cpp.png" alt="Image">
                        <h4>What you'll learn :</h4>
                        <p> --> Master C++ Basics.</p>
                        <p>--> Write clean C++ code from the start</p>
                          <p>--> Get the fundamentals you need for your next C++ projects.</p>
                          <p>-->Variables, functions, loops, conditions, and more.</p>
                          <p>--> install Visual Studio Code on Windows, Linux, and MacOS</p>
                          <p>--> Learn the Best Practices from the start.  </p>
                          <p>--> Learn by doing.</p>
                        <h4>Requirements :</h4>
                        <p>--> A computer and a strong will to learn, that’s it!</p>
                    </div>
               </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            ...
                            <h6 class="text-white my-3">10</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Duration</h6>
                            <h6 class="text-white my-3">7.00 Hrs</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Skill level</h6>
                            <h6 class="text-white my-3">Advanced</h6>
                        </div>
                        ...
                        <div class="py-3 px-4">
                           ...
                           <?php
                            ...
                            {  
                                 ...
                                 $query2="select * from sid_cid  where cid=105 and username = '$data2' ";
                                    ...
                                    if(isset($_POST['submit']))
                                      {
                                        ...
                                        $query3="insert into sid_cid() values('$data2',105)";
                                        $check_q3=mysqli_query($conn,$query3);
                                        if($check_q3==true)
                                        {
                                            ?>
                                            <p style=color:red;><?php echo "payment sucessful go and check in mycourses "?></p>;
                                            <?php
                                        }
                                        else
                                        {
