                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="mt-n1">
                                <h4>Our Location</h4>
                                <p class="m-0">Bheemili, Andhra Pradesh</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <p class="m-0">GURUCOOL@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <p class="m-0">GURUCOOLis an integrated set of interactive online services that provide trainers, learners, and others involved in education with information, tools, and resources to support and enhance education delivery and management</p>
                </div>
                <div class="col-md-6 mb-5">
