            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="img/html.jpeg" alt="Image">
                        <h4>What you'll learn :</h4>
                        <p> --> Become a modern and confident HTML and CSS developer, no prior knowledge needed!.</p>
                        <p>--> Modern, semantic and accessible HTML5</p>
                          <p>--> Important CSS concepts such as the box model, positioning schemes, inheritance, solving selector conflicts, etc.</p>
                          <p>--> Design and build a stunning real-world project for your portfolio from scratch.</p>
                          <p>--> Modern CSS (previous CSS3), including flexbox and CSS Grid for layout</p>
                          <p>-->  A web design framework with easy-to-use rules and guidelines to design eye-catching websites</p>
                          <p>--> </p>
                        <h4>Requirements :</h4>
                        <p>--> No coding or design experience necessary</p>
                        <p>--> Any computer works — Windows, macOS or Linux</p>
                        <p>--> You don’t need to buy any software — we will use the best free code editor in the world</p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <h5 class="text-white py-3 px-4 m-0">Course Price: $599</h5>
                        <div class="py-3 px-4">
                            <?php
                           ...
                           <?php
                            ...
                            {  
                                 ...
                                 $query2="select * from sid_cid  where cid=100 and username = '$data2' ";
                                    ...
                                    if(isset($_POST['submit']))
                                      {
                                        ...
                                        $query3="insert into sid_cid() values('$data2',100)";
