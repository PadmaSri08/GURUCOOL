            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="img/data.jpeg" alt="Image">
                        <h4>What you'll learn :</h4>
                       <p> Gain an immersive understanding of the practices and processes used by a junior or associate data analyst in their day-to-day job</p>

                     <p>Learn key analytical skills (data cleaning, analysis, & visualization) and tools (spreadsheets, SQL, R programming, Tableau)</p>

                        <p>Understand how to clean and organize data for analysis, and complete analysis and calculations using spreadsheets, SQL and R programming</p>

                         <p>Learn how to visualize and present data findings in dashboards, presentations and commonly used visualization platforms</p>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            ...
                            <h6 class="text-white my-3">Intermediate</h6>
                        </div>
                        <div class="d-flex justify-content-between px-4">
                            <h6 class="text-white my-3">Language</h6>
                            <h6 class="text-white my-3">English</h6>
                        </div>
                        <h5 class="text-white py-3 px-4 m-0">Course Price: $0</h5>
                        <div class="py-3 px-4">
                            <?php
                           ...
                           <?php
                            ...
                            {  
                                 ...
                                 $query2="select * from sid_cid  where cid=103 and username = '$data2' ";
                                    ...
                                    if(isset($_POST['submit']))
                                      {
                                        ...
                                        $query3="insert into sid_cid() values('$data2',103)";
